...
\newcommand{\projector}[1]{\ketbra{#1}{#1}}
\newcommand{\bfx}{\mathbf{x}}
\newcommand{\x}{\mathbf{x}}
\newcommand{\tr}{Tr}

\newcommand{\kLH}{{ $k$-LOCAL HAMILTONIAN}}
\newcommand{\FLH}{{ FERMIONIC  LOCAL HAMILTONIAN}}
\newcommand{\REP}{{ $N$-REPRESENTABILITY}}
\newcommand{\UF}{{ UNIVERSAL FUNCTIONAL}}
\newcommand{\ES}{{ ELECTRONIC STRUCTURE}}
\newcommand{\HF}{{HARTREE-FOCK}}
\newcommand{\tLH}{{2-LOCAL HAMILTONIAN}}
\newcommand{\qma}{{QMA}}
\newcommand{\np}{{ NP}}
\newcommand{\bqp}{{{BQP}}}
\newcommand{\bpp}{{{BPP}}}
...
\newcommand{\Had}{{\sf H}_p}
\newcommand{\acomm}[2]{[#1\,\;#2]_+}
\newcommand{\ie}{i.e.~}
\newcommand{\TwoE}[4]{\ad_{#1}\ad_{#2}a_{#3}a_{#4}}
...
\newcommand{\R}{\mathbf{R}_n}
\newcommand{\F}{\mathbf{F}}
\newcommand{\rr}{\mathbf{r}}%\r normally adds the o onto of Angstrom symbol
...
\newcommand{\ctrldt}[1]{\control \qwxdt[#1] \qw}
    % Inserts a control and connects it to the object #1 wires below.
